...
Once the site is open in Chrome/Edge on desktop or Android, use the browser's "Install app" option (or "Add to Home Screen" on iOS Safari) to install Cash Point Finance like a native app. It will work fully offline for the app shell; live data still needs a network connection to your server.
